...
include { UNTAR } from '/home/luisasantus/Desktop/multiplesequencealign/./modules/nf-core/untar/tests/../main.nf'
...
workflow {
    ...
    if (UNTAR.output){
        ...
        for (def name in UNTAR.out.getNames()) {
            serializeChannel(name, UNTAR.out.getProperty(name), jsonOutput)
        }	  
      
        // consumes all unnamed output channels and stores items in a json file
        def array = UNTAR.out as Object[]
