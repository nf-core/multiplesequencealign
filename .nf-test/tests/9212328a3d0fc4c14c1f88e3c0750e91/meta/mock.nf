...
include { checkCondaChannels } from '/home/luisasantus/Desktop/multiplesequencealign/subworkflows/nf-core/utils_nextflow_pipeline/main.nf'
...
workflow {
  ...
  result = checkCondaChannels(*input)
  if (result != null) {
