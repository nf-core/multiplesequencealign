...
workflow ALIGN {
    ...
    // Separate the computation into those which need a tree and those which don't
    ...
    // if null, create an empty value
    ch_fasta_trees_famsa.tree.map { tree ->
        if (tree == null) {
            // Replace "null" with an empty string and an empty list
